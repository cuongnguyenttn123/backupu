                        ...
                        <table class="table">
                            ...
                            @for($i=0;$i<count($bid);$i++)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="single-popup" href="{{$item['url']}}" style="margin-left:-8px;" style = "width:400px; height:auto">
                                            <button class="button button1" style="    margin-top: 0px;    float: right;      border-radius: 4px;    background-color: transparent;    padding: 4px 14px 4px 14px;">View</button></a>
                                    </td>
                                    <td>
                                        {{$item['time']}}
                                    </td>
                                    <!--<td>-->
                                    <!--   <a href = "{{url('/accept/'.$item['id'])}}" id = "accept" name = $bid onclick = "accept(this.name)"><button>Accept</button></a>-->
                                    <!--</td>-->
                                    <td>
                                        <select id="s{{$i}}" onchange="selectitem('{{$item['id']}}',this,'s'+'{{$i}}')"  class="custom-select" style="width:105px;
                                                @php
                                            switch ($item['state']){
                                                case '0':
                                                    echo "color:black";
                                        ...
                                        @endphp">
                                            <option  @php if($item['state']=='request') echo "selected";@endphp value="1">{{$item['state']}}</option> 
...
<script>
       function selectitem(item, selectObject,id){
            ...
            //   alert('Once your accept is approved by admin,then you need to charge 5% of this bid to our company!');
            }
            var val='';
            switch (value) {
                case '1':
            ...
            $.ajax({ 
                ...
                success: function(response){
                    ...
                    if(obj.data.val == 'Accepted'){
                        swal("Congrats!", "Once your bid is approved by the admin, 5% of the price will be deducted from your transaction as urpixpays commission.", "success"); 
                    }else{
                        alert(obj.message);
                        location.reload();
                    }
