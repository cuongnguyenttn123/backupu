...
@section('content')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title ">Challenge Table</h4>
    ...
    class="trigger fa fa-fire  u_pix_btn btn btn-outline-success" onclick="modal_popup(this.name);" style = "color: #9e9234;">Edit</a> 
                                    ...
                                    <td>
                                        <button class="trigger fa fa-fire  u_pix_btn btn btn-outline-success" id="{{$item['id']}}" onclick="myFunction1(this.id)">Award</button>
                                    </td>
                                    <td>
