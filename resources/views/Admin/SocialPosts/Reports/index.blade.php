                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">All Reports</span></h1>
                            </div>
                        </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="name" data-editable="">Report Person Name</th>
                                        <th data-field="email" data-editable="">Report Person Email</th>
                                        <th data-field="name against" data-editable="">Report Against peron Name</th>
                                        <th data-field="email against" data-editable="">Report Against Person Email</th>
                                        <th data-field="description"data-editable="">Post Description</th>
                                         <th data-field="report reason"data-editable="">Report Reason</th>
                                          <th data-field="report coment"data-editable="">Report Comment</th>
                                        <th data-field="image"data-editable="">Image</th>
                                        <th data-field="delete"data-editable="">Delete</th>
                                        <th data-field="edit"data-editable="">View Post</th>
                                   ...
                                   @foreach($report as $report)
                                    ...
                                    <td>
                                        {{$report->against->email}}
                                    </td>
                                    <td>
                                        {{   substr($report->post->description,0, 100)}}
                                    </td>
                                    <td>
                                        {{   substr($report->report_reason,0, 100)}}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                      @if($report->post->image)
                                        <image src="https://www.urpixpays.com/public/uploads/images/{{$report->post->image}}" style="height:100px;width:100px" />
                                        @else
                                        No Image Uploaded
                                        @endif
                                    </td>
                                     ...
                                     <td>
                                    <a href="{{route("delete.socialPost",$report->post->id)}}" class="btn btn-danger" type='button' >
                                    ...
                                    <td>
                                    <a href="{{route("edit-post",$report->post->id)}}" class="btn btn-primary" type='button' >
                                        <span style="color:white">
                                            View Post
                                        </span>
                                    </a>
