                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">All Posts</span></h1>
                            </div>
                        </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="description"data-editable="">Description</th>
                                        <th data-field="image"data-editable="">Image</th>
                                        <th data-field="status"data-editable="">Post Status</th>
                                        <th data-field="delete"data-editable="">Delete</th>
                                        <th data-field="edit"data-editable="">Edit</th>
                                   ...
                                   @foreach($posts as $post)
                                    ...
                                    <td>
                                      @if($post->image)
                                        <image src="https://www.urpixpays.com/public/uploads/images/{{$post->image}}" style="height:100px;width:100px" />
                                        @else
                                        No Image Uploaded
                                        @endif
                                    </td>
                                     <td>
                                      <select id="s-{{$post->id}}" onchange="selectitem('{{$post->id}}',this,'s-'+'{{$post->id}}')" style="
                                                 @php
                                                    switch ($post->status){
                                                        case '0':
                                                           echo "color:#ff0000";
                                                        ...
                                                        default:
                                                            ...
                                                            break;}
                                                @endphp">
                                            <option  @php if($post->status == 1) echo "selected";@endphp value="1">Approved</option>
                                            <option  @php if($post->status ==0) echo "selected";@endphp value="0">Not Approve</option>
                                        </select>
                                    </td>
                                     <td>
                                    <a href="{{route("delete.socialPost",$post->id)}}" class="btn btn-danger" type='button' >
                                    ...
                                    <td>
                                    <a href="{{route("edit-post",$post->id)}}" class="btn btn-primary" type='button' >
                                        <span style="color:white">
                                            Edit Post
                                        </span>
                                    </a>
