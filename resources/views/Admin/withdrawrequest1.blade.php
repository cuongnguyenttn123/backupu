                                      ...
                                      <td>
                                                <div class="dropdown">{{$withdraw[$i]->remark}}
                                                    <div class="dropdown-content">
                                                        <a href= "{{url('admin/withdraw_process1/'.$withdraw[$i]->id.'/Success')}}">Success</a>
                                                        <a href= "{{url('admin/withdraw_process1/'.$withdraw[$i]->id.'/Cancel')}}">Cancel</a>
                                                        <a href= "{{url('admin/withdraw_process1/'.$withdraw[$i]->id.'/Delete')}}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
