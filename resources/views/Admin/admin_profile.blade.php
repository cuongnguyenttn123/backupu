...
@section('content')
 ...
 <div class="container portfolio" style="clear:right;width:55%; height:auto;">
    <div class="row">
        <div class="col-md-12">
            <div class="heading">               
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-12" id="profile-pic-container">
                        <form id="form" method="post" action="{{url("adminsaveProfile")}}" enctype="multipart/form-data">
                            @csrf                       
                        <div class="bio-image">
                        ...
                        <!--<div id="image-overlay" style="    border-radius: 50%;    width: 220px; margin-top: 50px;         margin-left: 15px;    display: none;"></div>-->
                        </label>
