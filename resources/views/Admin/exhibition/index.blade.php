                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="ex_id">Exhibition id</th>
                                   ...
                                   @foreach($exhibitions as $exhibition)
                                    ...
                                    <td>
                                        {{@$exhibition->user->email}}
                                    </td>
                                    <td>
                                      @if($exhibition->image_name)
                                        <image src="https://urpixpays.com/public/uploads/exhebition/{{$exhibition->image_name}}" style="height:100px;width:100px" />
                                        @else
                                        No Image Uploaded
                                        @endif
                                    </td>
                                     <td>
                                    <a href="{{route("exhibition.delete",$exhibition->id)}}" class="btn btn-danger" type='button' >
