...
<head>
  ...
  <link rel="icon" href="https://urpixpays.com/public/images/logo0.png"/>
...
<div class="page-content">
    @include('userdashboardheader')
        ...
        @endif    
 <div class="container-fluid1" style="margin-top:100px;">
    <div class="myphotos-title" style="width:100%;height:50px;border-top-left-radius:5px;background:#0099cc;border-top-right-radius:5px;color:white;font-size:20px;font-family:arial;padding-left:30px;padding-top:10px;">My Photos</div>
    <div id="photos" class="d-flex flex-wrap bg-light" style = "margin-bottom: 90px;">
                @for($i=0;$i<count($images);$i++)
                    ...
                    <div class="image-card p-2" >
                        <div style="background-image: url('{{$item['url']}}');background-size: cover;background-position: center;width: 100%;z-index:0">
                        ...
                        @if(!$item['c-id'])
                        <a  class="btn btn-danger" onclick="onClickDelete({{$id}})" type="button" style="z-index: 999999" >
                           Delete Image 
                        </a>
                        @endif   
                        </div>
                        ...
                        <!--        <div style="display: none;vertical-align: middle">{{$item['name']}}</div>-->
                        <!--    </div>-->
                        <!--</div>-->
...
// </script>
  ...
  {
      var proceed = confirm("Are you sure you want to delete this photo?");
        if (proceed) {
          window.location.replace("https://www.urpixpays.com/DeletedPhoto/"+id);
          //proceed
        } else {
          //don't proceed
        }
