                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">Send Bulk Notification </span></h1>
                            </div>
                            <form method="post" enctype="multipart/form-data" action="#"  >
                            <input type='hidden' name='_token' value="{{csrf_token()}}" />
                            <div class="form-group-inner">
                            <label>Title</label>
                            <input id="Subject" name="Subject"  type="text" class="form-control" placeholder="Title" required/>
                            </div>
                             <div class="form-group-inner">
                            <label>Body</label>
                            <textarea id="Description" rows="5" name="description" type="text" class="form-control" placeholder="Body" required ></textarea>
                            <label>ExtraData</label>
                            <textarea maxlength="200" id="extraInfo" rows="5" name="extraInfo" type="text" class="form-control" placeholder="Extra Data" required ></textarea>
                            </div>
                            <div class="form-group-inner">
                                  <input  type="button" class="btn btn-primary" onclick="SendBulkEmail()" value="Send Bulk Notification" />
                            </div>
                            </form>
                        </div>
...
@section('script')
    ...
    <script>
     function SendBulkEmail() {
            ...
            data.append('title', $('#Subject').val());
            data.append('body', $('#Description').val());
            data.append('extraInfo',$('#extraInfo').val());
            
            $('.preloader-single').css("display", "block")

            $.ajax({
                type: "POST",
                url: "{{route('SendNotificationToMobile.send')}}",
                data: data,
