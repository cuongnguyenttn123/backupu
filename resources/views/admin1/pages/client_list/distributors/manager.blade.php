                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            ...
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">Manager</span> Table</h1>
                            </div>
                        </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="txt" data-editable="">Phone Number</th>
                                        <th data-field="comm" data-editable="">Address</th>
                                        <th data-field="date" data-editable="">Register Date</th>
                                        <th data-field="state1" data-editable="">Restaurant</th>
                                        <th data-field="permission" data-editable="">Permission</th>
                                        <th data-field="num" data-editable="">Admin Email</th>
                                    ...
                                    @for($i=0;$i<$counts;$i++)
                                        <tr>
                                            ...
                                            <td>{{$admins[$i]->phone_num}}</td>
                                            <td>{{$admins[$i]->address}}</td>
                                            <td>{{$admins[$i]->created_time}}</td>
                                            <td>{{$admins[$i]->restaurant}}</td>
                                            ...
                                            <td class="datatable-ct">
                                                <button id="edit-{{$i}}" title="Edit" class="pd-setting-ed">
                                                    ...
                                                    <p class="o-phone" style="display: none;">{{$admins[$i]->phone_num}}</p>
                                                    <p class="o-address" style="display: none;">{{$admins[$i]->address}}</p>
                                                    <p class="o-restaurant" style="display: none;">{{$admins[$i]->restaurant}}</p>
                                                    <p class="o-admin-email" style="display: none;">{{$admins[$i]->parent_email}}</p>
                                                </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group-inner">
                        ...
                        <input id="restaurant-name" type="text" class="form-control" placeholder="" />
                    </div>
                    <div class="form-group-inner">
                        <label>Admin Email</label>
                        <input id="admin-email" type="email" class="form-control" placeholder="" />
                    </div>
                </div>
            ...
            <div class="modal-dialog" style="width:450px;">
                ...
                <div class="modal-content" style="width:450px;border-radius: 10px 10px 0 0;">
                    <div class="modal-header" style="height: 40px;color: white;background-color: #007bff;border-radius: 5px 5px 0 0;">
                        ...
                        <h4 class="modal-title">Edit Manager<span></span></h4>
                    </div>
                    <div class="modal-body" style="height: auto;text-align: center">
                        <input type="text" id="id-add" style="display: none" required/>
                        <span>Name:</span><input type="text" id="name-add" style="padding:5px;margin-top:20px;margin-left:45px;margin-bottom:10px;width: 200px;height: 30px;" required/><br>
                        <span>Email:</span><input type="email" id="email-add" style="padding:5px;margin-left:47px;margin-bottom:10px;width: 200px;height: 30px;" required/><br>
                        <span>Phone: </span><input type="text" id="phone-add" style="padding:5px;margin-left:39px;margin-bottom:10px;width: 200px;height: 30px;" required/><br>
                        <span>address: </span><input type="text" id="address-add" style="padding:5px;margin-left:30px;margin-bottom:10px;width: 200px;height: 30px;" required/><br>
                        <span>Restaurant:</span><input type="text" id="restaurant-add" style="padding:5px;margin-left:16px;margin-bottom:10px;width: 200px;height: 30px;" required/><br>
                        <span>Admin Email:</span><input type="email" id="admin-add" style="padding:5px;margin-left:5px;margin-bottom:10px;width: 200px;height: 30px;" required/><br>
                    </div>
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            $('.breadcome-menu').append('' +
                ...
                '</li>' +
                '<li>' +
                '<span class="bread-blod">Managers</span>\n' +
                '</li>');
        });
        ...
        $( document ).ready(function() {
            $('.add_master').click(function () {
                ...
                $('#add-admin').click(function () {
                    ...
                    var res_name=$('#restaurant-name').val();
                    var admin_email=$('#admin-email').val();
                    if(admin_email != '' && res_name != '' && name != '' && email != '' && phone != '' && address != '' && password != ''){
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (type == 200) {
                                    ...
                                    alert('Please confirm admin email or restaurant name.');
                                }
                            },
            ...
            $('.pd-setting-ed').click(function(){
                ...
                var a_restaurant=$('#'+id).find('.o-restaurant').text();
                var a_admin_email=$('#'+id).find('.o-admin-email').text();
                ...
                $('#restaurant-add').val(a_restaurant);
                $('#admin-add').val(a_admin_email);
                ...
                $('#admin-edit').click(function () {
                    ...
                    var restaurant=$('#restaurant-add').val();
                    var admin_email=$('#admin-add').val();
