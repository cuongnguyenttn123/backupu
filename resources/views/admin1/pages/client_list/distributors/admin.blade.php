                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            ...
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">Admin</span> Table</h1>
                            </div>
                        </div>
                                    ...
                                    @for($i=0;$i<$counts;$i++)
                                        <tr>
                                            ...
                                            <td class="datatable-ct">
                                                <select id="s-{{$i}}" onchange="selectitem('{{$data[$i]->id}}',this,'s-'+'{{$i}}')" style="
                                                 @php
                                                    switch ($data[$i]->permission){
                                                        ...
                                                        default:
                                                            ...
                                                            break;}
                                                 @endphp">
                                                    <option  @php if(($data[$i]->permission) == '0') echo "selected";@endphp value="0">Active</option>
                                                    <option  @php if(($data[$i]->permission) == '1') echo "selected";@endphp value="1">Disabled</option>
                                                    <option  @php if(($data[$i]->permission) == '2') echo "selected";@endphp value="2">Delete</option>
                                                </select>
                                            </td>
                                            <td class="datatable-ct">
                                                <button id="edit-{{$i}}" title="Edit" class="pd-setting-ed">
                                                    <i class="fas fa-user-edit"></i>
                                                    <p class="o-id" style="display: none;">{{$data[$i]->id}}</p>
                                                    <p class="o-name" style="display: none;">{{$data[$i]->name}}</p>
                                                    <p class="o-email" style="display: none;">{{$data[$i]->email}}</p>
                                                    <p class="o-phone" style="display: none;">{{$data[$i]->phone_number}}</p>
                                                    <p class="o-address" style="display: none;">{{$data[$i]->city}}</p>
                                                                                            <p class="o-address" style="display: none;">{{$data[$i]->country}}</p>
                                                </button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group-inner">
                        ...
                        <input id="license" type="number" class="form-control" placeholder="" />
                    </div>
                </div>
            ...
            <div class="modal-dialog" style="width:450px;">
                ...
                <div class="modal-content" style="width:450px;border-radius: 10px 10px 0 0;">
                    ...
                    <div class="modal-body" style="height: auto;text-align: center">
                        ...
                        <span>license:</span><input type="number" id="license-add" style="padding:5px;margin-left:28px;margin-bottom:10px;width: 200px;height: 30px;" required/><br>
                    </div>
        ...
        $( document ).ready(function() {
            $('.add_master').click(function () {
                ...
                $('#add-admin').click(function () {
                    ...
                    if(name != '' && email != '' && phone != '' && address != '' && password != '' && license != ''){
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                if (type == 200) {
                                    ...
                                    alert('Please confirm admin email.');
                                }
                            },
            ...
            $('.pd-setting-ed').click(function(){
                ...
                var a_license=$('#'+id).find('.o-license').text();
