  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <div class="row">
           <div class="col-md-12">
               <form enctype="multipart/form-data" method="post" action="{{url('admin/upload_best_images0')}}">
                {{csrf_field()}}
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title " style="margin-top:20px;margin-left:20px;">Best Images</h4>
                </div>
                <div class="card-body">
                  ...
                  <form class="w-100 card-form-cn" action="{{url('admin/update_best_order0')}}" method="post" accept-charset="utf-8">
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              <div class="col text-right">
                                 <a class="btn btn-danger" href='{{url("admin/detele_best_image0/$value->id")}}'> Delete </a>
                              </div>
                            </div>
                          </div>
                        </div>
