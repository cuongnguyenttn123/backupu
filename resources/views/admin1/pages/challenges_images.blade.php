                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div style="float: right" class="btn btn-default add_master">Create Challenge</div>
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">Challenges</span></h1>
                            </div>
                        </div>
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    @for($i=0;$i<$counts;$i++)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$images[$i]->imgname}}</td>
                                            
                                    <td>
                                        <button  onclick="delete_images(this)" data_id = "{{$images[$i]->id}}" data_url="{{($item['url'])}}" title="Edit" class="pd-setting-ed">Delete</button>
                                    </td>
                    ...
                    <div class="" style="height: auto;margin-bottom: 5px;background-color: white;">
                        ...
                        <div class="col-md-12 col-lg-12 col-sm-12 row" style="height: 400px;width: 110%;margin-top: 20px">
                            <div class="col-md-6 col-lg-6 col-sm-6">
                                ...
                                <h6>Period</h6>
                                <input type="date" name="title" id="period_id"  value="" placeholder="Period"/>
...
@section('script')
    ...
    function delete_images(e){
        imageid = e.getAttribute('data_id');
        imageurl = e.getAttribute('data_url');
        $.ajax({
