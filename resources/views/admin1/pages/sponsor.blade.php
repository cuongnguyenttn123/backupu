                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">Sponsor Table</span></h1>
                            </div>
                        </div>
                            ...
                            <div class="datatable-dashv1-list custom-datatable-overright">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="depositamount" data-editable="">Deposit Amount</th>
                                        <th data-field="flip" data-editable="">Flip</th>  
                                        <th data-field="wand" data-editable="">Wand</th>  
                                        <th data-field="charge" data-editable="">Charge</th>                                          
                                    ...
                                    <tbody>
                                        @for($i=0;$i<count($sponsor);$i++)
                                            @php
                                                $item = json_decode(json_encode($sponsor[$i]), true);
                                            @endphp
                                            <tr>
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            $('.breadcome-menu').append('' +
                ...
                '</li>' +
                '<li>' +
                '<span class="bread-blod">Sponsor</span>\n' +
                '</li>');
        });
