...
<head>
    ...
    <style>
        .back_image{background: url("{{asset('/adminp/img/admin-login.jpg')}}") center;background-size: cover;}
    </style>
</head>
			...
			<div class="content-error">
				<div class="hpanel">
                    <div class="panel-body" style="opacity: 0.9;">
                        <form method="POST" role="form" action="{{url("adminlogin")}}" id="loginForm">
                            {{ csrf_field() }}
...
<script src="{{asset('adminp/js/metisMenu/metisMenu-active.js')}}"></script>
    ...
    <!-- icheck JS
		============================================ -->
    <script src="{{asset('adminp/js/icheck/icheck.min.js')}}"></script>
    <script src="{{asset('adminp/js/icheck/icheck-active.js')}}"></script>
    <!-- plugins JS
		============================================ -->
