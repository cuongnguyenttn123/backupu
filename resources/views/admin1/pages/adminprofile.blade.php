 ...
 <div class="container portfolio" style="clear:right;width:80%; height:auto;">
    ...
    <div class="bio-info">
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-12" id="profile-pic-container">
                        <form id="form" method="post" action="{{url("adminsaveProfile0")}}" enctype="multipart/form-data">
                            @csrf                       
                        <div class="bio-image">
            ...
            <div class="col-md-6" style="padding-top:0;margin-top:45px;" >
  
                        <table>
                          <tr>
                            <td>Name</td>
                            <td style='padding:0;'><input type='text' name='name' value='{{$a_name}}' style='width:150px;border:none;text-align: center;margin-bottom:0px !important;height:30px;'></input></td>
                          </tr>
                          <tr>
                            <td>Age</td>
                            <td style='padding:0;'><input type='text' name='age' value='{{$a_age}}' style='width:150px;border:none;text-align: center;background:none;margin-bottom:0px !important;height:30px;'></input></td>
                          </tr>
                          <tr>
                            <td>Country</td>
                            <td style='padding:0;'><input type='text' name='country' value='{{$a_country}}' style='width:150px;border:none;text-align: center;background:none;margin-bottom:0px !important;height:30px;'></input></td>
                          </tr>
                          <tr>
                            <td>City</td>
                            <td style='padding:0;'><input type='text' name='city' value='{{$a_city}}' style='width:150px;border:none;text-align: center;background:none;margin-bottom:0px !important;height:30px;'></input></td>
                          </tr>                          
                          <tr>
                            <td>Email</td>
                            <td style='padding:0;'><input type='email' name='email' value='{{$a_email}}' style='width:150px;border:none;text-align: center;background:none;margin-bottom:0px !important;height:30px;'></input></td>
                          </tr>
                          <tr>
                            <td>Phone Number</td>
                            <td style='padding:0;'><input type='text' name='phone' value='{{$a_phone}}' style='border:none;width:150px;text-align: center;background:none;margin-bottom:0px !important;height:30px;'></input></td>                            
                          </tr>
                          <tr style="height:30px;">
                            <td>Wallet</td>
                            <td style='padding:0;'><input type='text' name='walet' value='{{$a_walet}}' style='border:none;width:150px;text-align: center;background:none;margin-bottom:0px !important;height:30px;'></input></td>
                          </tr>
                          <tr style="height:30px;">
                            <td>Register Date</td>
                            <td>{{$a_date}}</td>
                        ...
                        <button type="submit" style="width:200px; background-color: #4CAF50;color: white;padding: 10px 20px;margin: 8px 0;border: none;border-radius: 4px;cursor: pointer;margin-top:47px;" id="submit">Update Profile</button>
                    </form>    
                </div>
            </div>
        </div>  
