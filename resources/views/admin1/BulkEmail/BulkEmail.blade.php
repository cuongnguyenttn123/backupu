                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">Bulk Email</span></h1>
                            </div>
                            <form method="post" enctype="multipart/form-data" action={{route('post.bulk.email')}}  >
                            ...
                            <textarea id="Description" rows="5" name="description" type="text" class="form-control" placeholder="Description" required ></textarea>
                            </div>
                            <div class="form-group-inner">
                                  <input  type="button" class="btn btn-primary" onclick="SendBulkEmail()" value="Send Bulk Email" />
                            </div>
                            </form>
                        </div>
