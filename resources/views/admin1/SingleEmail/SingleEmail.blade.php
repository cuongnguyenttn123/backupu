                    ...
                    <div class="sparkline13-list">
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                <h1><span class="table-project-n">Single Email</span></h1>
                            </div>
                            <form method="post" enctype="multipart/form-data" action={{route('post.single.email')}}  >
                            ...
                            <textarea id="Description" row="4" name="description" type="text" class="form-control" placeholder="Description" required></textarea>
                            </div>
                            <div class="form-group-inner">
                                  <input  type="submit" class="btn btn-primary" value="Send Single Email" />
                            </div>
                            </form>
                        </div>
