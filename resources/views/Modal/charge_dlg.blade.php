            ...
            <div class="modal-body ">
                <div CLASS="" style="margin: 0px;margin-top: 10px;">
                    ...
                    <div class="col-12" style="text-align: center;border-radius: 15px">
                        <img  style="width: 50%;height: 65%" src="{{asset('img/charge_my.gif')}}">

                    </div>
                </div>
                <div class="col-12 row" style="    margin: auto;height: 40px;margin-top: 10px ;">
                    <div class="col-6" style="height: 100%;text-align: center;">
                        <button onclick="charge(1)" style="font-size : 17px;margin:auto
                        ;width: 80%;border:1px solid #009933; border-radius: 5px;outline: none;background-color: #009933;color:white">Charge</button>
                    </div>
                    <div class="col-6" style="height: 100%;text-align: center;">
                        <button onclick="charge(2)" style="font-size : 17px;border:1px solid #ff6600;margin:auto;size: 15px;
