...
<!--</nav>-->
 ...
 <main class="page-content">
   ...
   <div class="col-sm-9 text-left" style="padding: 10px;min-height:768px">
                    <h5>Transferred Log</h5>
    <div class="row" style="margin: 10px">
        <div class="col-md-4 col-sm-12" style="background-color: white;height: 100px">
            <h4>Your Balance</h4>
            <span style="font-size: 2.5rem">${{$balence}}</span>
            <span style="font-size: 3rem;color: #3f9ae5;"></span>
        </div>
        <div class="col-md-8 col-sm-12" style="background-color: white;height: 100px">
            <h4>Welcome</h4>
            <span>You can check your deposit and withdrawal history in here.</span>
        </div>
    </div>
    <div id="exTab1">
        <ul class="nav nav-pills">
            <li class="active">
                <a href="#1a" data-toggle="tab" aria-expanded="true" class="active show"><button class="button button2">Deposit</button></a>
            </li>
            <li class="">
                <a href="#2a" data-toggle="tab" aria-expanded="false" class=""><button class="button button2">Withdraw</button></a>
            </li>
        </ul>
                ...
                <div class="table_div">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                           ...
                           <tr>
                                <td style="text-align: center">2019-02-11 00:01:02</td>
                            ...
                            <tr>
                                <td style="text-align: center">2019-02-11 19:19:38</td>
                                <td style="text-align: center">0</td>
                                <td style="text-align: center">100</td>
                                <td style="text-align: center">0</td>
                                <td style="text-align: center"></td>
                            ...
                            <tr>
                                <td style="text-align: center">2019-02-12 01:05:43</td>
                                <td style="text-align: center">0</td>
                            ...
                            <tr>
                                <td style="text-align: center">2019-02-14 01:19:16</td>
                                <td style="text-align: center">0</td>
            ...
            <div class="tab-pane" id="2a">
                <div class="table_div"> 
                    <table class="table table-hover" >
                        ...
                        <tbody style = "margin-top: 0px;background-color: white;">
                                                    <tr>
                                <td style="text-align: center">2019-02-11 00:56:18</td>
                                <td style="text-align: center">0</td>
                                <td style="text-align: center">123</td>
                                <td style="text-align: center">0</td>
                                <td style="text-align: center">paypal</td>
                                <td style="text-align: center">123</td>
                                <td><a href="">cancel</a><a href="">resend</a></td>
                                ...
                                <td style="text-align: center">success</td>
                                                    ...
                                                    <tr>
                                <td style="text-align: center">2019-02-16 02:36:12</td>
                                <td style="text-align: center">0</td>
                                <td style="text-align: center">500</td>
                                <td style="text-align: center">0</td>
                                <td style="text-align: center">paypal</td>
