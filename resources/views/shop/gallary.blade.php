...
@section('style-css')
    ...
    @section('content')
        ...
        <div id ="nav" class="row">
            <div class="s004 col-6" style="width:300px;">
                    <div class="inner-form" style="margin-left:36px;margin-bottom:5px;width:200px;">
                        <div class="input-field">
                            <input class="form-control" id="choices-text-preset-values" type="text" style="width:100%;min-width:200px;color:black;" size="200" placeholder="search..." />
        ...
        <div id="image_div" class="row">
            ...
            @for($i=$count1;$i<$count2;$i++) 
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12" style="padding: 10px" >
                    <div style = "background: none repeat scroll 0 0 #ffffff;    border: 1px solid #dedede;    box-sizing: border-box;    padding: 0px 5px 30px 4px; position: relative;">
                        <div id = "muImg" alt = " "style="background-image: url('{{$imgurl[$i]}}'); background-size: contain;background-repeat:no-repeat;background-position:center;height: 200px; margin-left: 0px;margin-top:5px;"></div>
                        <div id = "img_name">{{$imgname[$i]}}</div> 
                        <div id = "img_price" style = "float:left;">$0.99</div><div style = "float:right;"><a href='signin' data-toggle="modal" data-target="#signindlg0"><button class = "small green button">Details!</button></a></div>  
                        <!--<i id="dislike{{$imgid[$i]}}" class="fa fa-heart-o like " aria-hidden="true" style = "font-size: 30px; color: red; position: absolute;top: 10px;left: 10px; z-index: 7;" onclick="giveLike(0,{{$imgid[$i]}})"></i>-->
                        <!--<i id="like{{$imgid[$i]}}" class="fa fa-heart like ok" aria-hidden="true" style = "font-size: 30px; color: red; position: absolute; top: 10px;left: 10px; z-index: 7;" onclick="giveLike(1,{{$imgid[$i]}})"></i> -->
                        <!--<i id="dislike1{{$imgid[$i]}}" class="fa fa-question-circle-o" aria-hidden="true" onclick="giveLike1(0,{{$imgid[$i]}})" style = "font-size: 32px;   color:red;  position: absolute; top:10px; right:10px; z-index: 7;"></i>-->
                        <!--<i id="like1{{$imgid[$i]}}" class="fa fa-question-circle ok" aria-hidden="true" onclick="giveLike1(1,{{$imgid[$i]}})" style = "font-size: 32px;  color:red;  position: absolute;top:10px; right:10px; z-index: 7;"></i> -->
                    </div>
                   
                </div> 
            @endfor 
        </div>
                        <!--<a id="first" href='signin' data-toggle="modal" data-target="#signindlg"><button class = "small green button">Details!</button> </a>-->
        <!--<button id="submit_btn" type="button" onclick="senddata()" class="btn btn-primary btn-lg" style = "float:right;">Submit</button>-->
                    ...
                    //   console.log('sdf'); //----------------------------------------------------------------------------------------------------
                        ...
                        for(var i=obj.data.count1;i<obj.data.count2;i++){
                            $('#image_div').append(
                                ...
                                '<div class="col-lg-3 col-md-4 col-sm-6 col-12" style="padding: 10px" >' +
                                ' <div style = "background: none repeat scroll 0 0 #ffffff;    border: 1px solid #dedede;    box-sizing: border-box;    padding: 0px 5px 30px 4px; position: relative;">'+
                                '<div style="background-image: url('+obj.data.imgurl[i]+'); background-size: contain;background-repeat:no-repeat;background-position:center; height: 200px; margin-left: 0px;margin-top:5px;">' +'</div>' +
                                '<div id = "img_name">'+obj.data.imgname[i]+'</div>' +
                                '<div id = "img_price" style = "float:left;">$0.99</div>'+
                                "<a href='signin' data-toggle='modal' data-target='#signindlg0'><div style = 'float:right;'><button class = 'small green button'>Details!</button></div></a>"+
                                // '<i id="dislike'+obj.data.imgid[i]+'" class="fa fa-heart-o like " aria-hidden="true" style = "font-size: 30px; color: red; position: absolute;top: 10px;left: 10px; z-index: 7;" onclick="giveLike(0,'+obj.data.imgid[i]+')"></i>'+
                                // '<i id="like'+obj.data.imgid[i]+'" class="fa fa-heart like ok" aria-hidden="true" style = "font-size: 30px; color: red; position: absolute; top: 10px;left: 10px; z-index: 7;" onclick="giveLike(1,'+obj.data.imgid[i]+')"></i>'+
                                // '<i id="dislike1'+obj.data.imgid[i]+'" class="fa fa-question-circle-o" aria-hidden="true" onclick="giveLike1(0,'+obj.data.imgid[i]+')" style = "font-size: 32px;   color:red;  position: absolute; top:10px; right:10px; z-index: 7;"></i>'+
                                // '<i id="like1'+obj.data.imgid[i]+'" class="fa fa-question-circle ok" aria-hidden="true" onclick="giveLike1(1,'+obj.data.imgid[i]+')" style = "font-size: 32px;  color:red;  position: absolute; top:10px; right:10px; z-index: 7;"></i>'+
                                '</div>'+'</div>')
                        }
                        ...
                        // <i id="dislike1{{$imgid[$i]}}" class="fa fa-question-circle-o" aria-hidden="true" onclick="giveLike1(0,{{$imgid[$i]}})" style = "font-size: 32px;   color:#0e0e0e;  position: absolute; top: 40px; left: 10px; z-index: 7;"></i>
                        // <i id="like1{{$imgid[$i]}}" class="fa fa-question-circle ok" aria-hidden="true" onclick="giveLike1(1,{{$imgid[$i]}})" style = "font-size: 32px;  color:#0e0e0e;  position: absolute; top: 40px; left: 10px; z-index: 7;"></i>
                    ...
                    success: function(response){
                        ...
                        for(var i=obj.data.count1;i<obj.data.count2;i++){
                            $('#image_div').append(
                                ...
                                '<div class="col-lg-3 col-md-4 col-sm-6 col-12" style="padding: 10px" >' +
                                ' <div style = "background: none repeat scroll 0 0 #ffffff;    border: 1px solid #dedede;    box-sizing: border-box;    padding: 0px 5px 30px 4px; position: relative;">'+
                                '<div style="background-image: url('+obj.data.imgurl[i]+'); background-size: contain;background-repeat:no-repeat;background-position:center; height: 200px; margin-left: 0px;margin-top:5px;">' +
                                '</div>' +
                                '<div id = "img_name">'+obj.data.imgname[i]+'</div>' +
                                '<div id = "img_price" style = "float:left;">$0.99</div>'+
                                "<a href='signin' data-toggle='modal' data-target='#signindlg0'><div style = 'float:right;'><button class = 'small green button'>Details!</button></div></a>"+
        ...
        function senddata() {
            ...
            $.ajax({
                url: '{{url('voting/set1')}}',
                type: 'post',
                data: {likearry:likearry,question:question, uid:uid} ,
                beforeSend: function (request) {
                    return request.setRequestHeader('X-CSRF-Token', $("meta[name='csrf-token']").attr('content'));
                },
                success: function(response){
