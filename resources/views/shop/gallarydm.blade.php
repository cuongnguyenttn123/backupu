    ...
    border-radius: 5px;}
        ...
        @section('content')
            ...
            {{------------------------------------------First Image Show-------------------------------------------------------}}
            <div id="image_div" class="masonry">
                
                @for($i=$count1;$i<$count2;$i++) 
                
                    <div class="item" style="padding: 10px" >
                        <div style = "background: none repeat scroll 0 0 #ffffff;    border: 1px solid #dedede;    box-sizing: border-box;    padding: 5px 5px 10px 4px; position: relative;">
                            <div id = "muImg"><img src="{{$imgurl[$i]}}"></div>
                            <div id = "img_price" style = "position: absolute;bottom: 40px;padding: 2px 5px;" class="small green button">$0.99</div><div style = "position: absolute;right: 10px;bottom: 40px;"><a href = "#"  data-toggle="modal" data-target="#signindlg"><button id = "{{$imgid[$i]}}" class = "small green button">Details!</button></a></div> 
                        ...
                        //   console.log('sdf'); //----------------------------------------------------------------------------------------------------
                            ...
                            for(var i=obj.data.count1;i<obj.data.count2;i++){
                                $('#image_div').append(
                                    ...
                                    '<div class="item" style="padding: 10px" >' +
                                    ' <div style = "background: none repeat scroll 0 0 #ffffff;    border: 1px solid #dedede;    box-sizing: border-box;    padding: 5px 5px 10px 4px; position: relative;">'+
                                    '<div><img src="'+obj.data.imgurl[i]+'"></div>' +
                                    '<div id = "img_price" style = "position: absolute;bottom: 40px;padding: 2px 5px;" class="small green button">$0.99</div>'+
                                    '<a href = "#"  data-toggle="modal" data-target="#signindlg"><div style = "position: absolute;right: 10px;bottom: 40px;"><button id = "" class = "small green button">Details!</button></div></a>'+
