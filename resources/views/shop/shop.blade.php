...
@section('style-css')
    ...
    @section('content')
        ...
        {{-----------------------------------------Search and Fillter---------------------------------------------------------------}}
        <div><a href="{{url('/cart')}}" class = " small green button"  style="float: right;background-color:;font-size: 20px;"><i class="fa fa-shopping-cart" aria-hidden="true">({{$cart_count}})</i></a></div>
            ...
            @for($i=$count1;$i<$count2;$i++) 
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-12" style="padding: 10px" >
                    <div style = "background: none repeat scroll 0 0 #ffffff;    border: 1px solid #dedede;    box-sizing: border-box;    padding: 0px 5px 30px 4px; position: relative;">
                        ...
                        <div id = "img_price" style = "float:left;">$0.99</div><div style = "float:right;"><a href = "{{url('/auction/'.$imgid[$i])}}"><button id = "{{$imgid[$i]}}" class = "small green button">Details!</button></a></div>  
                    ...
                    //   console.log('sdf'); //----------------------------------------------------------------------------------------------------
                        ...
                        for(var i=obj.data.count1;i<obj.data.count2;i++){
                            $('#image_div').append(
                                ...
                                '<a href ="'+"auction/"+obj.data.imgid[i]+'"><div style = "float:right;><button id = "" class = "small green button">Details!</button></div></a>'+
