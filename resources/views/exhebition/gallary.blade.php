...
@if(Session::get('login_flag') != 'login')
    <div class="input-group" style="margin: 20px 0px 10px;">
        <div class="input-group-append" style="margin:0 auto;">
            <button data-toggle="modal" data-target="#signindlg"  type="button" style="border: unset;background: unset;width: 200px;"><p class="btn btn-outline" style="width:100%;background: #0099cc;border-radius: 5px;margin-top: 20px;"><i class="fa fa-upload" aria-hidden="true"></i> Upload</p>
            </button>
        </div>
    </div>
@else
    <div class="input-group" style="margin: 20px 0px 10px;">
        <div class="input-group-append" style="margin:0 auto;">
            <button class="exibitiom_btn"  type="button" style="border: unset;background: unset;width: 200px;"><p class="btn btn-outline" style="width:100%;"><i class="fa fa-upload" aria-hidden="true"></i> Upload</p>
            </button>
        </div>
    </div>
@endif
